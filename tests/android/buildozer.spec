...
# block the tests that run against pywebview's local Bottle server. The
...
# into the <application> tag; android.extra_manifest_xml injects into
# <manifest> instead and so would not work for this attribute.
